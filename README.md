...
<table align="center" width="100%">
  ...
  <tr>
    ...
    <td align="center" width="33.3%" valign="top">
      <p><b>Lumen Motion</b></p>
      <img src="https://fastly.jsdelivr.net/gh/SXP-Simon/astrbot_plugin_qq_group_daily_analysis@main/assets/lumen_motion-demo.jpg" alt="lumen_motion" width="100%">
    </td>
    <td align="center" width="33.3%" valign="top"></td>
  </tr>
</table>
...
Worker 构建时会自动从主仓库拉取 Worker 运行代码和模板；主仓库更新后，重新构建一次 Worker 即可同步。
...
uv run scripts\debug_render.py -t lumen_motion -o debug_lumen_motion.html
```
